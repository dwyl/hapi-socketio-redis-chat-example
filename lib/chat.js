(function() {
	...
	var pub         = redis.createClient(rc.port, rc.host); // create client
	pub.auth(rc.auth); // *optionally* authenticate when using RedisCloud;
	var sub         = redis.createClient(rc.port, rc.host); // create client
	sub.auth(rc.auth); // *optionally* authenticate when using RedisCloud;
